...
class ApplicationRequest extends FormRequest
{
    ...
    {
        return [
            'application_name' => 'required|max:30',
            ...
            'used_technology' => 'required|max:500',
            'pr_message' => 'present|max:500',
            'additional_features' => 'present|max:500',
            'other_message' => 'present|max:500',
