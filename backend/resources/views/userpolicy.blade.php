@extends('layout/app')
@section('navContents')
@section('titleTag', '利用規約')
@endsection
@section('mainContents')

    <section class="section section">
        <div class="content">
            <h2 class="head-title head-title--section-title">利用規約</h2>
            <div class="content u-text-left">
                この利用規約（以下，「本規約」といいます。）はhiroyuki-w(以下、「当方」といいます。)がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。<br><br>
                ...
                <div class="mt-30">
                    ...
                    <ol class="list-style-type-disc">
                        ...
                        当方，本サービスの他のユーザーまたは第三者の知的財産権，肖像権，プライバシー，名誉その他の権利または利益を侵害する行為<br>
                ...
                <div class="mt-30">
                    ...
                    <ol class="list-style-type-disc">
                        ...
                        <li>当方が本サービスの利用を適当でないと判断した場合</li>
